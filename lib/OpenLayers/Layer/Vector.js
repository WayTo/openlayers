...
OpenLayers.Layer.Vector = OpenLayers.Class(OpenLayers.Layer, {
     ...
     * dragging - {Boolean} 
     */
    moveTo: function(bounds, zoomChanged, dragging, imageTransform) {
        OpenLayers.Layer.prototype.moveTo.apply(this, arguments);
        
        var coordSysUnchanged = true;
        if (!dragging) {
            this.renderer.root.style.visibility = 'hidden';
            var imageUrl = imageTransform && this.features.length > 0 && this.isLoading ? this.renderer.clear(true) : undefined;
            ...
            if (imageUrl) {
              this.renderer.drawImage(imageUrl, imageTransform);
            }
    ...
    drawFeature: function(feature, style) {
        ...
        if (typeof style != "object") {
            ...
            if (renderIntent == "temporary") {
            	style = this.styleMap.createSymbolizer(feature, renderIntent);
            	style.renderIntent = renderIntent;
            }
            else if (feature.useFixedStyle) {
                style = feature.style;
            }
            else {
